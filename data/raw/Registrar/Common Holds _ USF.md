[Skip to Main Content](https://www.usf.edu/registrar/services/holds.aspx#content)
...
Listed below are the common holds that could prevent registration or the release of
transcripts and diplomas, along with general instructions for addressing the hold.
If you have a hold that is not on this list, you can find more information on the
Registration Status page of your [Student Self-Service](https://bannersso.usf.edu/ssomanager/c/SSB) account.

**\*Note:** Students with a hold that prevents adding, dropping or withdrawing from class sections
may contact asktheregistrar@usf.edu from their USF email to drop or withdraw if the [applicable deadline](https://www.usf.edu/registrar/calendars/index.aspx) has not passed.

|  |  |  |  |
| --- | --- | --- | --- |
| **Explanation of Hold** | **Prevents Release of Transcript** | **Prevents Adding, Dropping and Withdrawing from Class Sections\*** | **Prevents** **Release of Diploma** |
| **First Year Advising Required (AA)** **-** Use [Archivum](https://my.usf.edu/) Appointment Scheduling to meet with an academic advisor in your college. |  | ✓ |  |
| **Degree Admission Denied (AD) -** Degree-Seeking admission was denied. Non-Degree Seeking students, contact the Office of the Registrar at nondegree@usf.edu to resolve. Degree-seeking students, contact the Office of Admissions at transfer@usf.edu to resolve. |  | ✓ |  |
| **FSR Advising Required (AF) -** Use [Archivum](https://my.usf.edu/) Appointment Scheduling to meet with an academic advisor in your college. |  | ✓ |  |
| **Contact Academic Advising (AL) -** Use [Archivum](https://my.usf.edu/) Appointment Scheduling to meet with an academic advisor in your college. |  | ✓ |  |
| **Contact Academic Advising (AO) -** Contact the Academic Advising team in your College to discuss your major and first-term registration. |  | ✓ |  |
| **Academic Probation (AP) -** Use [Archivum](https://my.usf.edu/) Appointment Scheduling to meet with an academic advisor in your college. |  | ✓ |  |
| **Academic Probation (AQ) -** Use [Archivum](https://my.usf.edu/) Appointment Scheduling to meet with an academic advisor in your college. |  | ✓ |  |
| **Missing Admission Docs (AR) -** Undergraduate students should visit the Applicant Portal to resolve.  Graduate students should visit Graduate Next Steps to resolve. |  | ✓ |  |
| **Unmet College Requirement (AS) -** Use [Archivum](https://my.usf.edu/) Appointment Scheduling to meet with an academic advisor in the College of Arts & Sciences. |  | ✓ | ✓ |
| **Contact Admissions Office (AZ) -** The Office of Admissions must take action on your record. Please contact as follows:  First-Year International Undergraduates: Email international@usf.edu to resolve.  First-Year Undergraduates: Email admissions@usf.edu to resolve.  Graduate Students: Email gradadmissions@usf.edu to resolve. | ✓ |  | ✓ |
| **Unmet College Requirement (BA) -** Use [Archivum](https://my.usf.edu/) Appointment Scheduling to meet with an academic advisor in the Muma College of Business. |  | ✓ | ✓ |
| **Returned Checks (BC) -** Email Student Accounting Services at busfin-sasreturns@usf.edu to resolve. |  | ✓ | ✓ |
| **Debt Owed (BD) -** Email Student Accounting Services at sfsarhelp@usf.edu to resolve. |  | ✓ | ✓ |
| **Unmet College Requirement (BH) -** Use [Archivum](https://my.usf.edu/) Appointment Scheduling to meet with an academic advisor in the College of Behavioral & Community Sciences. |  | ✓ | ✓ |
| **Bulls Bucks Balance (BK) -** Email Student Accounting Services at sfsarhelp@usf.edu to resolve. |  |  | ✓ |
| **Grad Student Orientation (BO) -** Complete Orientation Requirements with the Muma College of Business. Contact bsn-grad@usf.edu to resolve. |  | ✓ |  |
| **Mid-Term Grade Concern (BU) -** Use [Archivum](https://my.usf.edu/) Appointment Scheduling to meet with an academic advisor in the Muma College of Business. |  | ✓ |  |
| **Pay Balance Due (CA) -** Go to your Account Summary in [Student Self-Service](https://my.usf.edu/) to review and pay your balance. Hold is automatically cleared upon zero balance. |  |  | ✓ |
| **Pay Balance Due (CC) -** Go to your Account Summary in [Student Self-Service](https://my.usf.edu/) to review and pay your balance. This hold is automatically cleared upon zero balance. |  | ✓ | ✓ |
| **Student Health & Wellness (CH) -** Contact [Student Health & Wellness](https://www.usf.edu/student-affairs/student-health-services/) to resolve. |  | ✓ |  |
| **Take Career Nav in Canvas (CS) -** Log into [Canvas](https://my.usf.edu/) and complete the “Career Navigator- Kick-start Your Career Journey” class. This hold is released automatically within 6 hours upon completion of this training. |  | ✓ |  |
| **Contact Academic Advising (EN) -** Use [Archivum](https://my.usf.edu/) Appointment Scheduling to meet with an academic advisor in the College of Engineering. |  | ✓ | ✓ |
| **Unmet College Requirement (EO) -** Use [Archivum](https://my.usf.edu/) Appointment Scheduling to meet with an academic advisor in the College of Education. |  | ✓ | ✓ |
| **Unmet College Requirement (FB) -** Use [Archivum](https://my.usf.edu/) Appointment Scheduling to meet with an academic advisor in the College of Design, Art & Performance. |  | ✓ | ✓ |
| **Complete Grad App (G1) -** In [Student Self-Service](https://my.usf.edu/), select “Apply to Graduate,” and then “Complete Graduation Survey.” This hold is automatically cleared upon survey completion. | ✓ |  | ✓ |
| **Readmission after P3 (G3) -** To finalize your readmission after academic probation, contact the Office of Graduate Studies at gradappeals@usf.edu. | ✓ | ✓ |  |
| **Complete Grad App (G5) -** In [Student Self-Service](https://my.usf.edu/), select “Apply to Graduate,” and then “Complete Graduation Survey.” This hold is automatically cleared upon survey completion. | ✓ |  | ✓ |
| **Complete Grad App (G8) -** In [Student Self-Service](https://my.usf.edu/), select “Apply to Graduate,” and then “Complete Graduation Survey.” This hold is automatically cleared upon survey completion. | ✓ |  | ✓ |
| **Required BME Advising (GB) -** Use [Archivum](https://my.usf.edu/) Appointment Scheduling to meet with an academic advisor in Biomedical Engineering to resolve. |  | ✓ |  |
